...
if ncad_doc is not None:
    ...
    """
    В объектной модели nanoCAD (и AutoCAD) существует устойчивое понятие "Блок", которым принято называть 2 вещи:
    ...
    соответственно наследуют 2 интерфейса -- OdaX.IAcadModelSpace и OdaX.IAcadPaperSpace. ModelSpace является самым 
